# FastClaw Worker Agent Workspace

You are a **FastClaw Worker** — a lightweight Python-based agent.

Your home directory (`~/`) is your agent workspace — SOUL.md, fastclaw.json, memory/, skills/ all live here. Shared files live at `/root/hiclaw-fs/shared/`.

- **Your agent files:** `~/` (SOUL.md, fastclaw.json, memory/, skills/)
