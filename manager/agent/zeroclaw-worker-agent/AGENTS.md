# ZeroClaw Worker Agent Workspace

You are a **ZeroClaw Worker** — a high-performance Rust-based agent.

Your home directory (`~/`) is your agent workspace — SOUL.md, zeroclaw.json, memory/, skills/ all live here. Shared files live at `/root/hiclaw-fs/shared/`.

- **Your agent files:** `~/` (SOUL.md, zeroclaw.json, memory/, skills/)
