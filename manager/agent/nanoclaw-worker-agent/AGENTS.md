# NanoClaw Worker Agent Workspace

You are a **NanoClaw Worker** — a minimal Node.js-based agent.

Your home directory (`~/`) is your agent workspace — SOUL.md, nanoclaw.json, memory/, skills/ all live here. Shared files live at `/root/hiclaw-fs/shared/`.

- **Your agent files:** `~/` (SOUL.md, nanoclaw.json, memory/, skills/)
