...
export HICLAW_MATRIX_URL="${HICLAW_MATRIX_URL:-http://127.0.0.1:6167}"
export HICLAW_AI_GATEWAY_URL="${HICLAW_AI_GATEWAY_URL:-http://aigw-local.hiclaw.io:8080}"
...
VARS='${HICLAW_STORAGE_PREFIX} ${HICLAW_MATRIX_DOMAIN} ${HICLAW_MATRIX_URL}
